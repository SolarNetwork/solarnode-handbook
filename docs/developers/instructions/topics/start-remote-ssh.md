---
title: StartRemoteSsh
---
# `StartRemoteSsh` topic

This instruction requests the node to establish a SSH connection to a specific host for the purposes
of system administration.

=== "StartRemoteSsh example"
...
=== "StartRemoteSsh example (compact)"
...
A `Completed` state indicates the node has established the SSH connection.
