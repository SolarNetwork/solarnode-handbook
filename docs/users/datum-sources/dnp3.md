...
Once installed, a new **DNP3 Control Center** component will appear on the [Settings > Components][components]
page on your SolarNode. Click on the **Manage** button to configure components.

<figure markdown>
  ![DNP3 Control Center component](../../images/users/datum-sources/dnp3-cc-component@2x.png){width=1024 loading=lazy}
</figure>

## CSV Configurer

SolarNode supports configuring DNP3 Control Center components using a simple comma-separated-values (CSV)
file, which spreadsheet applications can easily generate. A **DNP3 Control Center CSV Configurer** component will appear on the [Settings > Services][services] page. This form lets you upload a DNP3 Control Center CSV
Configuration file to configure all DNP3 Control Center components at once, without having to use the
[settings](#settings) form.

<figure markdown>
  ![DNP3 Control Center CSV Configurer form](../../images/users/datum-sources/dnp3-cc-csv-configurer@2x.png){width=948 loading=lazy}
</figure>

!!! tip "Spreadsheet jumpstart"

    You can copy the [DNP3 Control Center Configuration Example][sheet-example] sheet as a
    starting point. This sheet has drop-down menu validation to make it super easy to configure your
    DNP3 integration. Download your completed Sheet as CSV, then use the **DNP3 Control Center
...
<figure markdown>
  ![DNP3 example spreadsheet configuration](../../images/users/datum-sources/dnp3-cc-csv-example@2x.png){width=1383 loading=lazy}
</figure>
...
| `N` | **Index** | integer |  | The DNP point type index to collect .|
...
<figure markdown>
  ![DNP3 Control Center settings](../../images/users/datum-sources/dnp3-cc-config@2x.png){width=950 loading=lazy}
</figure>
...
| DNP3 Connection          | The **Service Name** of [DNP3 client connection][dnp3-conn] to use. |
...
<figure markdown>
  ![DNP3 Measurement settings](../../images/users/datum-sources/dnp3-cc-measurement-config@2x.png){width=952 loading=lazy}
</figure>
...
| Property Type   | The datum [property type][prop-types] to publish measurement values as. |
...
[sheet-example]: https://docs.google.com/spreadsheets/d/1ZYAfR8NFbY11f5SLlGuXqOadG32FH4c4WsixRbcOekQ
