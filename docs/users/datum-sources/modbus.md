...
<figure markdown>
  ![Modbus Device instance names](../../images/users/datum-sources/modbus-device-named-component-instances@2x.png){width=972 loading=lazy}
</figure>
...
| `D` | **Connection** | string | `Modbus Port` | The **Service Name** of the [Modbus connection][modbus-conn] to use. |
...
<figure markdown>
  ![Modbus Device Datum Source settings](../../images/users/datum-sources/modbus-device-settings@2x.png){width=874 loading=lazy}
</figure>
...
| Modbus Connection  | The **Service Name** of the [Modbus connection][modbus-conn] to use. |
...
| Datum Filter Service | The **Service Name** of a datum filter to apply. **Note** that configuring global [datum filters](../datum-filters/index.md) is generally more flexible. |
| Sub-sample Frequency | If configured, the frequency at which samples should be collected from the device, in milliseconds. Set to `0` (or empty) to disable. Typically this would be combined with a **Datum Filter Service** to transform the sub-samples. See the [Sub-sampling](#sub-sampling) section for more information. **Note** that the [Downsample Filter][DownsampleFilter] can be used to accomplish the same thing. |
...
<figure markdown>
  ![Metadata settings](../../images/users/datum-sources/modbus-device-metadata-settings@2x.png){width=874 loading=lazy}
</figure>
...
<figure markdown>
  ![Property settings](../../images/users/datum-sources/modbus-device-property-settings@2x.png){width=872 loading=lazy}
</figure>
...
properties that are dynamically calculated from other properties or raw Modbus register values.

<figure markdown>
  ![Expressions settings](../../images/users/datum-sources/modbus-device-expression-settings@2x.png){width=872 loading=lazy}
</figure>
...
!!! tip
	...
	**Note** that this type of average sub-sampling can be achieved more simply by configuring
