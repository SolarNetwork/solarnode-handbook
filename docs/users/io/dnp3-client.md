...
Once installed, a new **DNP3 TCP Client** component will appear on the [Settings > Components][components]
page on your SolarNode. Click on the **Manage** button to configure components.

<figure markdown>
  ![DNP3 TCP Client component](../../images/users/io/dnp3-tcp-client-component@2x.png){width=1024 loading=lazy}
</figure>

## Settings

<figure markdown>
  ![DNP3 TCP client settings](../../images/users/io/dnp3-tcp-client-config@2x.png){width=950 loading=lazy}
</figure>
